%% Shaping_2Choice_vGitHub.m

% the Shaping_2Choice_vGitHub is built from behaviortrainingv4 with only the go
% trials

function varargout = Shaping_2Choice_vGitHub(varargin)
% SHAPING_2CHOICE_VGITHUB MATLAB code for Shaping_2Choice_vGitHub.fig
%      SHAPING_2CHOICE_VGITHUB, by itself, creates a new SHAPING_2CHOICE_VGITHUB or raises the existing
%      singleton*.
%
%      H = SHAPING_2CHOICE_VGITHUB returns the handle to a new SHAPING_2CHOICE_VGITHUB or the handle to
%      the existing singleton*.
%
%      SHAPING_2CHOICE_VGITHUB('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SHAPING_2CHOICE_VGITHUB.M with the given input arguments.
%
%      SHAPING_2CHOICE_VGITHUB('Property','Value',...) creates a new SHAPING_2CHOICE_VGITHUB or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Shaping_2Choice_vGitHub_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Shaping_2Choice_vGitHub_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Shaping_2Choice_vGitHub

% Last Modified by GUIDE v2.5 11-Dec-2025 09:51:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Shaping_2Choice_vGitHub_OpeningFcn, ...
                   'gui_OutputFcn',  @Shaping_2Choice_vGitHub_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Shaping_2Choice_vGitHub is made visible.
function Shaping_2Choice_vGitHub_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output argHs, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Shaping_2Choice_vGitHub (see VARARGIN)
...
% Choose default command line output for Shaping_2Choice_vGitHub
clear global
...
% UIWAIT makes Shaping_2Choice_vGitHub wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Shaping_2Choice_vGitHub_OutputFcn(hObject, eventdata, handles) 
